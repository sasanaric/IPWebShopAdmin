...
<div class="container">
    <div class="login-frame">
        <div class="login-form">
            <form method="POST" action="?action=update-attribute&id=<%=categoryBean.getAttribute().getId()%>">
                <div class="form-row">
                    Naziv atributa <br />
                    <label for="name">
                        <input type="text" name="name" id="name" value="<%=categoryBean.getAttribute().getName()%>"/><br />
                    </label>
                </div>
